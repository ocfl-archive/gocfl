...
func TestHashedNTuple(t *testing.T) {
	...
	// Example 1
	l := NewStorageLayoutHashedNTuple(&StorageLayoutHashedNTupleConfig{
		ExtensionConfig: &extensiontypes.ExtensionConfig{ExtensionName: "0004-hashed-n-tuple-storage-layout"},
