...
func (object *ObjectBase) AddReader(r io.ReadCloser, path string, area string, noExtensionHook bool) error {
	...
	if !noExtensionHook {
		if err := object.extensionManager.AddFileAfter(object, nil, path, targetFilename, digest); err != nil {
