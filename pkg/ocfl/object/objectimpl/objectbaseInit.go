...
func (objectBase *ObjectBase) Init(fsys streamfs.FS, id string, digest checksum.DigestAlgorithm, fixity []checksum.DigestAlgorithm, extensionManager extensiontypes.ExtensionManagerCore) error {
	...
	*/
	...
	subFS, err := writefs.Sub(fsys, "extensions")
	if err != nil {
