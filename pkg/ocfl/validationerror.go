...
var ErrorE001 = &ValidationError{Code: E001, Description: "The OCFL ObjectBase Root must not contain files or directories other than those specified in the following sections.", Ref: "https://ocfl.io/1.0/spec/#E001"}
...
var ErrorE003 = &ValidationError{Code: E003, Description: "[The version declaration] must be a file in the base directory of the OCFL ObjectBase Root giving the OCFL version in the filename.", Ref: "https://ocfl.io/1.0/spec/#E003"}

// var ErrorE003 = &ValidationError{Code: E003, Description: "There must be exactly one version declaration file in the base directory of the OCFL ObjectBase Root giving the OCFL version in the filename.", Ref: "https://ocfl.io/draft/spec/#E003"}
...
var ErrorE008 = &ValidationError{Code: E008, Description: "OCFL ObjectBase content must be stored as a sequence of one or more versions.", Ref: "https://ocfl.io/1.0/spec/#E008"}
...
var ErrorE033 = &ValidationError{Code: E033, Description: "An OCFL ObjectBase InventoryBase MUST follow the [JSON] structure described in this section and must be named inventory.json.", Ref: "https://ocfl.io/1.0/spec/#E033"}
var ErrorE034 = &ValidationError{Code: E034, Description: "An OCFL ObjectBase InventoryBase must follow the [JSON] structure described in this section and MUST be named inventory.json.", Ref: "https://ocfl.io/1.0/spec/#E034"}
...
var ErrorE036 = &ValidationError{Code: E036, Description: "An OCFL ObjectBase InventoryBase must include the following keys: [id, type, digestAlgorithm, head]", Ref: "https://ocfl.io/1.0/spec/#E036"}
...
var ErrorE042 = &ValidationError{Code: E042, Description: "Content paths within a manifest block must be relative to the OCFL ObjectBase Root.", Ref: "https://ocfl.io/1.0/spec/#E042"}
var ErrorE043 = &ValidationError{Code: E043, Description: "An OCFL ObjectBase InventoryBase must include a block for storing versions.", Ref: "https://ocfl.io/1.0/spec/#E043"}
...
var ErrorE063 = &ValidationError{Code: E063, Description: "Every OCFL ObjectBase must have an inventory file within the OCFL ObjectBase Root, corresponding to the state of the OCFL ObjectBase at the current version.", Ref: "https://ocfl.io/1.0/spec/#E063"}
var ErrorE064 = &ValidationError{Code: E064, Description: "Where an OCFL ObjectBase contains inventory.json in version directories, the inventory file in the OCFL ObjectBase Root must be the same as the file in the most recent version.", Ref: "https://ocfl.io/1.0/spec/#E064"}
...
var ErrorE072 = &ValidationError{Code: E072, Description: "The directory hierarchy used to store OCFL Objects MUST NOT contain files that are not part of an OCFL ObjectBase.", Ref: "https://ocfl.io/1.0/spec/#E072"}
...
var ErrorE081 = &ValidationError{Code: E081, Description: "OCFL Objects within the OCFL Storage Root also include a conformance declaration which MUST indicate OCFL ObjectBase conformance to the same or earlier version of the specification.", Ref: "https://ocfl.io/1.0/spec/#E081"}
var ErrorE082 = &ValidationError{Code: E082, Description: "OCFL ObjectBase Roots MUST be stored either as the terminal resource at the end of a directory storage hierarchy or as direct children of a containing OCFL Storage Root.", Ref: "https://ocfl.io/1.0/spec/#E082"}
...
var ErrorE085 = &ValidationError{Code: E085, Description: "Storage hierarchies MUST be terminated by OCFL ObjectBase Roots.", Ref: "https://ocfl.io/1.0/spec/#E085"}
...
var ErrorE092 = &ValidationError{Code: E092, Description: "The value for each key in the manifest must be an array containing the content paths of files in the OCFL ObjectBase that have content with the given digest.", Ref: "https://ocfl.io/1.0/spec/#E092"}
