...
func NewStorageRootV1_1(ctx context.Context, fsys fs.FS, extensionFactory *extensionimpl.ExtensionFactory, extensionManager ExtensionManager, logger zLogger.ZLogger) (*StorageRootV1_1, error) {
...
func (osr *StorageRootV1_1) Init(ver version.OCFLVersion, digest checksum.DigestAlgorithm, manager extension.ExtensionManagerCore) error {
	/*
