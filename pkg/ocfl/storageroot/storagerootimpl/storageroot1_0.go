...
func NewStorageRootV1_0(ctx context.Context, fsys fs.FS, extensionFactory *extensionimpl.ExtensionFactory, manager ExtensionManager, logger zLogger.ZLogger) (*StorageRootV1_0, error) {
