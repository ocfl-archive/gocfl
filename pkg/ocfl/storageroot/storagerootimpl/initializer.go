...
func NewInitializer(ctx context.Context, factory factory.FactoryStorageRoot, extensionFactory extension.Factory[storageroot.ExtensionManager], a any, logger ocfllogger.OCFLLogger) storageroot.Initializer {
	return &initializer{
		ctx:              ctx,
		factory:          factory,
