...
func NewFactory20(extensionFactory *extensionimpl.ExtensionFactory, extensionManager objecttypes.ExtensionManager, logger zLogger.ZLogger) factorytypes.Factory {
	return &factory20{
		logger:  logger,
