...
func NewInitialDummyFS(fsys fs.FS) (types.Extension, error) {
...
func NewInitialDummy(config *types.ExtensionManagerConfig) (*InitialDummy, error) {
...
var (
	_ types.Extension = &InitialDummy{}
)
