...
func TestObjectUpdate(t *testing.T) {
	...
	require.Equal(t, "v2", inv.GetHead().String())
	...
	require.NoError(t, err)
	require.True(t, foundTest1, "test1.txt should be in v2 state")
	require.True(t, foundTest2, "test2.txt should be in v2 state")
}
