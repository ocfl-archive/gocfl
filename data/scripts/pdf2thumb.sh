...
gs -dNOPAUSE -dBATCH -sDEVICE=png16m -dFirstPage=1 -dLastPage=1 -sOutputFile="$TEMP_PNG" "$SOURCE"
...
convert "$TEMP_PNG" -resize "${WIDTH}x${HEIGHT}" -background "$BACKGROUND" -gravity Center -extent "${WIDTH}x${HEIGHT}" "$DESTINATION"
