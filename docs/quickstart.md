...
## Validating an OCFL Object

To validate an OCFL Storage Root with all objects, run the `validate` command:
...
where `XXX`is the digest algorithm used for the manifest.
